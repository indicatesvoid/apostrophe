...
module.exports = {
  construct: function(self) {
    ...
    self.defaultControls = [ 'style','JustifyLeft', 'JustifyRight', 'JustifyCenter', 'bold', 'italic', 'createLink', 'unlink', 'insertUnorderedList', 'insertTable', 'slideshow', 'buttons', 'video', 'files', 'embed', 'pullquote', 'html' ];
